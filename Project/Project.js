...
const MENUPAGE=(ELEMENT)=>{
    ...
    BUTTONIMAGE(ELEMENT,'forestgreen','App Sync','',WHITERETRYICON,'50px',()=>{
    ...
    CONDITION(Delete,()=>{
        ...
        GETINDEXEDDATA ('AppManager', 'AppManager', (data)=>{
            ...
            CHECKER( data.Owner === Name && data.AppDeleted ,()=>{
                ...
                VIEW(ELEMENT,' ','30%','30%','5% auto',(ELEMENTS)=>{
    
                    STYLED(ELEMENTS,'display','inline-table');
                    STYLED(ELEMENTS,'border','1px solid forestgreen');
    
                    TOPLEFTIMAGE(ELEMENTS,WHITECHECKICON,'25px','25px','5%','5% auto',(ELEMENTSE)=>{
        ...
        GETINDEXEDDATA ('AppManager', 'AppManager', (data)=>{
            ...
            CHECKER( data.Owner === Name && !data.AppDeleted ,()=>{
                ...
                VIEW(ELEMENT,' ','30%','30%','',(ELEMENTS)=>{
                    ...
                    TOPLEFTIMAGE(ELEMENTS,WHITEDELETEICON,'25px','25px','5%','5% auto',(ELEMENTSE)=>{
                    ...
                    IMAGE(ELEMENTS,data.AppIcon||WHITEFOLDERICON,'60%','70%','10% auto',()=>{
