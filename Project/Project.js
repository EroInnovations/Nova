...
const ANDROIDHOMEPAGE=()=>{
    ...
    const WELCOMENOTE=`Ero Innovations,We are the lead Developer in Cloud Native Software.

    <br><br>

    Get Your Latest Android ,Desktop and Website Built with Cutting Fully Proven and Tested Softwares and Frames to Get Your Ideas to Life .
    ...
    HOMESCROLLHEADERTEMPLATE('',' ',' ',(ELEMENT)=>{
        ...
        LEFTTEXT(ELEMENT,'',WELCOMENOTE,'','16px','1rem','',()=>{
